...
import s from './WholesaleDrugDetails.module.css'
import { ReactComponent as DrugListIcon } from '../../assets/drugCtn.svg'
import { ImSpinner8 } from 'react-icons/im'
import { useEffect, useState } from 'react'
import { useCart } from '../../context/CartContext'

export default function WholesaleDrugDetails({ drug, loading }) {
    ...
    <div className={s.ctn}>
      <div className={s.wrp}>
        <h1 className={s.mainTitle}>
          <Link to="/dashboard/wholesaler">All Medications {'>'}</Link> {drug.drugName}
        </h1>
          ...
          <div className={s.right}>
            ...
            <div className={s.drugDetails}>
              ...
              <div className={s.quantity}>
                <p className={s.label}>Quantity Ctn</p>
